That does not work for me. I need that exact text animation, with my existing styling. These are the instruction on the website to integrate the elements:
Install:
npm: OR manual
npm:
npx shadcn@latest add @react-bits/Shuffle-JS-TW 
